...
const icons = {
  ...
  wallet: `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 6h14a2 2 0 0 1 2 2v10H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h12"/><path d="M15 11h7v4h-7a2 2 0 0 1 0-4Z"/></svg>`,
...
const services = [
  ...
  { id: "credit", icon: icons.wallet, title: "Рассрочка и кредит", text: "Можно разделить покупку на 3, 6 или 12 месяцев. Условия заранее объясним в переписке." },
